...
//builder.Services.AddSingleton<ICountryRepository, InMemoryRepository>(); // instancia unica, dura toda la vida de la aplicacion
//builder.Services.AddScoped<ICountryRepository, FileCountryRepository>(); // una instancia por ambito, en caso de un controlador sería por request, lo que dure el get
